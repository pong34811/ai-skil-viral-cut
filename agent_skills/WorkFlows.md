...
│     - บันทึกทับ .srt เดิม                                    │
│                                                              │
│  3. 🔍 หาช่วงน่าสนใจ (30 วินาที - 3 นาที)                    │
│     - เหตุการณ์วุ่นวาย, จังหวะตลก, โต้ตอบ                   │
│     - จุดอารมณ์พุ่งสูง, เหตุการณ์สำคัญ                       │
│     - ถ้าช่วงสั้นกว่า 30s → ตัดเท่าที่มี ไม่ต้องขยาย         │
└──────────┬───────────────────────────────────────────────────┘
           │
           ▼
┌──────────────────────────────────────────────────────────────┐
...
3. คัดเลือกช่วงที่น่าสนใจ โดยมีความยาว **30 วินาที - 3 นาที** ต่อ cut (**ขั้นต่ำ 30 วินาที**)
   - ถ้าช่วงน่าสนใจสั้นกว่า 30 วินาที: ตัดเท่าที่มี — ไม่ต้องขยาย context
