...
│   └── cut_clips.py           — ตัดคลิปวิดีโอตาม timestamp
...
├── AGENTS.md                  — AI auto-update instructions
...
3. AI จะทำงานตาม workflow:
   ...
   - **Step 5** — Export Excel
   - **Step 6** — ตัดคลิปวิดีโอ (cut_clips.py)
   - **Step 7** — อัปเดต References.md
   - **Step 8** — consistency check + อัปเดต Welcome.md
